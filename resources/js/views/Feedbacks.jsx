        ...
        <div className='row'>
            <div className="col">
                <div className={"row " + classes.menuWrapper}>
                    <div className={`col ${classes.menu} ${feedbacksType === 1 ? classes.menuActive : ''}`} onClick={() => setType(1)}>
                        Проблемы
                    </div>
                    <div className={`col ${classes.menu} ${feedbacksType === 2 ? classes.menuActive : ''}`} onClick={() => setType(2)}>
                        Идеи
                    </div>
                </div>
